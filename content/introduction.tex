...
Ebenso bezeichnet \Var{\&a} die Adresse eines Objekts und mit \Var{*p} die Dereferenzierung eines Zeigers \Var{p}.
...
Beispielsweise wird verlangt, dass eine Prozedur \Method{new} zu Verfügung steht, die bei der Erzeugung eines neuen Objekts Speicher reserviert und die entsprechende Speicheradresse zurückgibt.
