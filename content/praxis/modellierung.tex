...
So weist etwa der Java-Code der \code{MarkSweep}-Klasse starke Ähnlichkeiten zum Pseudocode in Algorithmus~\ref{algo:tricolor} auf (siehe Listing~\ref{java:tricolor-mark}).
