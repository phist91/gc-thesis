...
Dieses bildet die Grundlage für das Model der \code{JComboBox} des Auswahlfensters.
...
Der dritte Parameter -- ebenfalls vom Typ \code{Runnable} -- ist optional und wird verwendetn, um ein zusätzliches Einstellfenster zu erzeugen.
