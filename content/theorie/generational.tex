...
Abschließend werden überblicksartig weitere Möglichkeiten zur Partitionierung des Heaps betrachtet.
...
Bereits in Abschnitt~\ref{sec:naive-rc} wurde festgestellt, dass Referenzzählungen -- bedingt durch nötige Schreibbarrieren -- die Performance einer Anwendung beeinträchtigt, wenn viele Manipulationen von Referenzen stattfinden.
