...
\begin{proof}
	...
	Foglich kam es zu einer Iteration der \WHILE-Schleife (Zeile~11) mit $\Var{ref} = \&b$ und, da $\Var{\&b[i]} \in \Fields(\Var{b})$, wurde auch hier \Var{a} nach \Var{target} kopiert und \Var{b[i]} angepasst.
