...
\begin{figure}[h]
	\centering
	\includestandalone[scale=0.9]{img/tikz/ch4-fenichel01}\\[1cm]
	\includestandalone[scale=0.9]{img/tikz/ch4-fenichel02}\\[1cm]
	\includestandalone[scale=0.9]{img/tikz/ch4-fenichel03}\\[1cm]
	\includestandalone[scale=0.9]{img/tikz/ch4-fenichel04}\\[1cm]
	\includestandalone[scale=0.9]{img/tikz/ch4-fenichel05}\\[1cm]
	\includestandalone[scale=0.9]{img/tikz/ch4-fenichel06}\\[1cm]
...
Ein Handle $\mathtt{\tilde{a}}$ eines Objekts \Var{a} ist ein weiteres Objekt, das lediglich die Speicheradresse von \Var{a} enthält und eine feste Position im Speicher besitzt.
Alle Objekte besitzen anstelle einer Referenz auf \Var{a} dann eine solche auf $\mathtt{\tilde{a}}$.
Ändert sich die Position von \Var{a} im Speicher, ist lediglich eine Anpassung der Speicheradresse in $\mathtt{\tilde{a}}$ nötig.

\todo[inline]{Bild Handles}

\todo[inline]{Realisierung, doppelte Speicherzugriffe}