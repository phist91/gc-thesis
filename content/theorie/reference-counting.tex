...
Die Garbage Collection mithilfe naive Referenzzählung bietet im Vergleich zum Mark-Sweep-Algorithmus einige Vorteile (vgl. \cite[S. 58--60]{handbook}):
...
Die einzelnen Objekte werden dann nicht als löschbar erkannt, was zu einem Speicherleck führt. \todo[inline]{Ausblick auf nächste Abschnitte}
