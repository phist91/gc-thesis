...
\begin{algorithmic}[1]
	...
	\State \quad \quad \ELSE \Method{remove}(\Var{MRT}, \Var{obj})
	\State \quad \ELSE \Method{add}(\Var{ZCT}, \Var{obj})
	\Statex
...
\begin{algorithmic}[1]
	...
	\State \quad \quad \Method{addLog}(\Var{\&obj[i]}, \Var{obj[i]})
	\State \quad \quad \Method{setModified}(\Var{\&obj[i]})
	\State \quad $\Var{obj[i]} \gets ref$
	\Statex
