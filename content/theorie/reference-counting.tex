...
\begin{figure}[h]
	...
	\end{subfigure}
	\caption[Ausführung von \Method{markGray}(\Var{b})]{Beispielhafte Ausführung von \Method{markGray}(\Var{b}) nach Entfernen der Referenz $\Var{a} \rightarrow \Var{b}$. Dick umrandet sind diejenigen Objekte, für welchs gerade der rekursive Aufruf von \Method{markGray} abgearbeitet wird.}
