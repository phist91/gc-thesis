...
\begin{algorithmic}[1]
	...
	\State \quad \quad \quad \IF (\Var{ref} $\neq$ \Null $\wedge$ \Method{isNotMarked}(\Var{*ref}))	
...
\begin{figure}[h]
	...
	\caption[Veranschaulichung eines in Regionen aufgeteilten Heaps]{Veranschaulichung eines in Regionen aufgeteilten Heaps. Jede Region kann Objekten einer festgelegten Größenordnung zugewiesen werden. Für eine Größenordnung können allerdings mehrere Regionen verwendet werden.}
