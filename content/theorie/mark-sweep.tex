...
\todo[inline]{Bild Listenstruktur}
...
Davon ausgehend, dass in \Var{toDo} ausschließlich Referenzen konstanter Größe gespeichert werden, ergibt sich insgesamt ein Platzbedarf von $\Theta(|\Reach|)$.
