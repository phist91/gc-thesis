...
\begin{document}
	\begin{tikzpicture}	
		...
		\arrowTop{16.25}{18.5}{0.35}{}				% f' -> c'
		\arrowTop{10.5}{16.75}{0.55}{\toNursery}		% B -> f'
		\arrowTop{9.5}{15.5}{0.35}{\toNursery}		% A -> g'
		\arrowBottom{14.5}{16.25}{0.35}{}			% b' -> f'
		\arrowBottom{15.5}{17.5}{0.75}{}			% g' -> e'
		\arrowBottom{16.75}{12.5}{0.55}{\toMature}	% f' -> D
		\arrowBottom{0.5}{13.5}{0.35}{\toMature}		% a -> E
		
		\draw (2*\xscale,-2.5*\yscale) node[right]{\textbf{toDo:} \Var{e'}, \Var{c'}};
