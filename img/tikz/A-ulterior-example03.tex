...
\begin{document}
	\begin{tikzpicture}	
		...
		\arrowTop{5.25}{2.5}{0.5}{}					% f -> e
		\arrowTop{10.5}{5.75}{0.75}{\toNursery}		% B -> f
		\arrowTop{9.5}{15.5}{0.5}{\toNursery}		% A -> g'
		\arrowBottom{14.5}{5.25}{0.65}{}			% b' -> f
		\arrowBottom{15.5}{4.5}{0.85}{}				% g' -> e
		\arrowBottom{5.75}{12.5}{0.5}{\toMature}	% f -> D
		\arrowBottom{0.5}{13.5}{1}{\toMature}		% a -> E
		
		\draw (2*\xscale,-2.5*\yscale) node[right]{\textbf{toDo:} \Var{b'}, \Var{g'}};
		\draw (11*\xscale,-2.5*\yscale) node[right]{\textbf{log:} $\Var{B} \rightarrow \Var{f}$};
