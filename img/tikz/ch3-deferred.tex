...
\begin{document}
	\begin{tikzpicture}[->, auto, thick,
		...
		\node[state] (E) at (4,0) {$\emptyset$};
		\node[state] (Z) at (8,0) {\Var{ZCT}};
		\node[state] (F) at (12,0) {\Method{free}};
		...
		\draw[->,ctcolormain,thick] (9,-1.5) -- (10,-1.5) node[right,font=\footnotesize\itshape]{incRefCount};
		\draw[->,ctcoloraccessory,thick] (9,-2) -- (10,-2) node[right,font=\footnotesize\itshape]{decRefCount};
		\draw[->,red,thick] (9,-2.5) -- (10,-2.5) node[right,font=\footnotesize\itshape]{collect};
	\end{tikzpicture}
\end{document}