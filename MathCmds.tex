...
% ===========================================================
	...
	\newcommand{\Mature}{\textsc{Mature}\xspace}
	\newcommand{\Nursery}{\textsc{Nursery}\xspace}
	
	\newcommand{\Cpp}{C\nolinebreak\hspace{-.05em}\raisebox{.2ex}{\footnotesize\bfseries +}\nolinebreak\hspace{-.10em}\raisebox{.2ex}{\footnotesize\bfseries +}\xspace}
	
	
	\newcommand{\stereo}[1]{\code{\frqq #1\flqq}\xspace}
